  ...
  return (
    <aside className="rounded-3xl border border-line bg-card p-5">
          ...
          return (
            <label
              ...
              className={cn(
                ...
                active ? "border-accent bg-accent/20 shadow-[0_0_0_1px_#8E00EC]" : "border-line hover:border-glow",
              )}
            >
      ...
      <button
        ...
        className="mt-5 w-full rounded-full bg-accent py-3.5 text-sm font-semibold text-accent-ink transition hover:bg-glow"
      >
      ...
      <button
        ...
        className="mt-2 w-full rounded-full border border-line py-3 text-sm font-medium text-ink hover:border-glow"
      >
        Add to cart
      </button>
      <PaymentMarks />
